...
[![Web Applications with Citrix ADC](/en-us/tech-zone/design/media/reference-architectures_web-apps-citrix-adc.png)](/en-us/tech-zone/design/media/reference-architectures_gdpr_web-apps-citrix-adc.png)
...
Citrix Files (ShareFile) clients for iOS and Android which are managed by Citrix Endpoint Management can also use the embedded VPN capabilities provided by the CEM SDK. See “Data Encryption in Transit” in the Securing Mobile Applications section of this document for more details.
