...
description: The article covers guidance and best practices for using Citrix User Profile Manager to manage user profiles on Azure Files as the back-end storage repository.
---
