...
1.  Repeat those steps for the Workspace for web policy with the "CitrixReceiver").NOT expression, click Edit, and click Edit again for the Profile. ![Create Authentication Profile](/en-us/tech-zone/learn/media/poc-guides_cvad-azuread-federation_000-ADCauthprofile.png)
