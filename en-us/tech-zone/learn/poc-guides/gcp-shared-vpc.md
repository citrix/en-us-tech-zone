...
>**Note**:
>
>To review the permissions required for the currently shipping Citrix Virtual Apps and Desktops product, see the Citrix documentation site [describing resource
locations](/citrix-virtual-apps-desktops-service/install-configure/resource-location/google.html).
...
![IAM and Admin configuration option](/media/poc-guides_gcp-shared-vpc_001.jpg)

#### Create Role

Select **Create Role**:

![Create Role option](/media/poc-guides_gcp-shared-vpc_002.jpg)

#### Empty Create Role Screen

A screen resembling the following appears:

![Empty Create Role screen](/media/poc-guides_gcp-shared-vpc_003.jpg)

#### Fill in the Name and ADD PERMISSION

Specify the **Role Name**. Click **ADD PERMISSIONS** to apply the update:

![Role name specification](/media/poc-guides_gcp-shared-vpc_004.jpg)
...
![Choosing the correct permission](/media/poc-guides_gcp-shared-vpc_011.jpg)

![Correct permission entry](/media/poc-guides_gcp-shared-vpc_012.jpg)

Click **ADD**.

The two Mandatory permissions added to our role:

![Mandatory permission role](/media/poc-guides_gcp-shared-vpc_013.jpg)
...
![Four permissions granted](/media/poc-guides_gcp-shared-vpc_014.jpg)
...
![Subnet-level role](/media/poc-guides_gcp-shared-vpc_015.jpg)
...
![Service Account entry](/media/poc-guides_gcp-shared-vpc_019.jpg)
...
![Select role for Service Account](/media/poc-guides_gcp-shared-vpc_020.jpg)
...
![More Select a Role option](/media/poc-guides_gcp-shared-vpc_021.jpg)

#### Specify the Role

Since we know the Role we want to apply, we can start typing. Once the intended Role appears, select the role:

![Role selection](/media/poc-guides_gcp-shared-vpc_022.jpg)

#### Select and Save

After selecting the Role, click **Save**:

![Save the role](/media/poc-guides_gcp-shared-vpc_023.jpg)
...
![Shared VPC screen](/media/poc-guides_gcp-shared-vpc_024.jpg)
...
![Subnets](/media/poc-guides_gcp-shared-vpc_025.jpg)
...
![Add Member option](/media/poc-guides_gcp-shared-vpc_026.jpg)
...
![Service Account option](/media/poc-guides_gcp-shared-vpc_027.jpg)
...
![Computer Network Users Role](/media/poc-guides_gcp-shared-vpc_028.jpg)
...
![Select Role](/media/poc-guides_gcp-shared-vpc_029.jpg)
...
![Added members](/media/poc-guides_gcp-shared-vpc_030.jpg)
...
![Project ID number](/media/poc-guides_gcp-shared-vpc_031.jpg)
...
![Assigning a role](/media/poc-guides_gcp-shared-vpc_032.jpg)
...
![Firewall options](/media/poc-guides_gcp-shared-vpc_033.jpg)
...
![Create Firewall rule](/media/poc-guides_gcp-shared-vpc_034.jpg)

#### Create New Firewall Screen

The screen used to create a new firewall rules is shown below:

![Create new firewall rule](/media/poc-guides_gcp-shared-vpc_035.jpg)
...
![Final screen](/media/poc-guides_gcp-shared-vpc_036.jpg)
...
![Completed rule screen](/media/poc-guides_gcp-shared-vpc_037.jpg)
...
![Network settings panel](/media/poc-guides_gcp-shared-vpc_038.jpg)
...
![Networks shared with me options](/media/poc-guides_gcp-shared-vpc_039.jpg)
...
![Network Settings panel](/media/poc-guides_gcp-shared-vpc_040.jpg)
...
![Second network interface](/media/poc-guides_gcp-shared-vpc_041.jpg)
...
![Host connection](/media/poc-guides_gcp-shared-vpc_042.jpg)
...
![Selecting project and region](/media/poc-guides_gcp-shared-vpc_043.jpg)
...
![Possible errors](/media/poc-guides_gcp-shared-vpc_044.jpg)
...
![Selected resources](/media/poc-guides_gcp-shared-vpc_045.png)
...
![Summary screen](/media/poc-guides_gcp-shared-vpc_046.jpg)
